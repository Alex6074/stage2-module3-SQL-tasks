...
insert into subject (name, description, grade) values ('Art and music', 'description', 1);
insert into subject (name, description, grade) values ('Geography and history', 'description', 2);
insert into subject (name, description, grade) values ('PE and math', 'description', 3);
insert into subject (name, description, grade) values ('Science and IT', 'description', 4);
...
insert into mark (student_id, subject_id, mark) values (select id from student where name = 'Mark', select id from subject where name = 'Art', 8);
